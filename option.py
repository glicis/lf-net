...
parser.add_argument("--path_pre_pth", type=str, default='./pth/LFT_5x5_4x_model.pth', help="path for pre model ckpt")
...
if args.task == 'SR':
    ...
    args.patch_size_for_test = 4
    args.stride_for_test = 2
